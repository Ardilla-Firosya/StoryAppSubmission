...
import com.example.storyappsumbission.DataDummy
import com.example.storyappsumbission.ListStoryAdapter
import com.example.storyappsumbission.MainDispatcherRule
import com.example.storyappsumbission.getOrAwaitValue
...
class MainViewModelTest{
    ...
    fun `when Get Quote Should Not Null and Return Data`() = runTest {
        ...
        val actualQuote: PagingData<ListStoryItem> = mainViewModel.getStoryUser().getOrAwaitValue()
